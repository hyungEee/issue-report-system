...
- 본 프로젝트는 글로벌 이슈를 동일한 기준으로 수집하고 비교할 수 있는 구조를 만드는 데 초점을 두었습니다. **세계 각국의 원문 기사**를 통합적으로 수집한 뒤 이를 하나의 기준으로 분석함으로써, 개별 국가가 아닌 세계의 관점에서 이슈를 선별하고 전달하는 것을 목표로 하였습니다.
