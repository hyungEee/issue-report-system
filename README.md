...
본 프로젝트는 글로벌 이슈를 동일한 기준으로 수집하고 비교할 수 있는 구조를 만드는 데 초점을 두었습니다.</br>
**세계 각국의 원문 기사**를 통합적으로 수집한 뒤 이를 하나의 기준으로 분석함으로써, 개별 국가가 아닌 ‘세계의 관점’에서 이슈를 선별하고 전달하는 것을 목표로 하였습니다.</br></br>
또한, 본 프로젝트에서는 리포트 작성 단계에서만 부분적으로 AI를 활용하였고, 데이터 수집 및 분석 과정은 명시적인 규칙 기반 설계로 구성한 것이 특징입니다.</br>
